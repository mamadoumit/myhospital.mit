...
<body>
	<div class="nous">
		<div class="moi">
			...
			<div class="ligne3">
			<p>Découvrez nos domaines d'interventions</p>
			</div>
		...
		<div class="ligne6">
			<ul>
				...
				<img class ="im" src="6.png" alt="logo de mon site web"></img>
				<img class ="im2" src="8.png" alt="second logo de mon site web"></img>
				</div>
			</ul>
		</nav>
		</header>
